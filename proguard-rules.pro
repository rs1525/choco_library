...
# Keep all public classes and methods in the Choco library
-keep public class com.akustom15.choco.** {
    public *;
}

# Keep model classes for JSON serialization
-keep class com.akustom15.choco.models.** { *; }
